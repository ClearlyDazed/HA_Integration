...
SOURCES = {
    "TV mode": ["KEY_TV", "KEY_SOURCE", "KEY_ENTER"],
    "Mode 2": ["KEY_TV", "KEY_SOURCE", "KEY_RIGHT", "KEY_ENTER"],
    "Mode 3": ["KEY_TV", "KEY_SOURCE", "KEY_RIGHT", "KEY_RIGHT", "KEY_ENTER"],
    "Mode 4": [
        "KEY_TV",
        "KEY_SOURCE",
        "KEY_RIGHT",
...
class SamsungTVDevice(SamsungTVEntity, MediaPlayerEntity):
    ...
    async def async_turn_on(self) -> None:
        ...
        LOGGER.error("Samsung Legacy TV's do not support TURNING ON")
